<template>
  <rs-layout>
          ...
          <div class="w-full" style="flex-direction: column">
            ...
            <div style="display: flex; flex-direction: row">
              <div class="w-11/12 h-1">
                <FormKit v-model="search" id="search-sticky" placeholder="Search for a user..." type="search" :classes="{
                  inner:
            ...
            <div class="">
              <rs-card style="padding-top: 10px">
                <div>
                  <div>
                    <DataTable :value="searchUsers" :paginator="true" :rows="10"
                      ...
                      <Column :exportable="false" style="min-width: 8rem">
                        <template #body="searchUsers">
                          <Button icon="pi pi-folder-open" class="p-button-rounded p-button-success" /> {{ "" }}
    ...
    <rs-modal title="Edit User" v-model="modalEdit" position="middle" size="md">
    ...
    <rs-modal title="Delete User" v-model="modalDelete" position="middle" size="md">
      <p>Are you sure you want to delete this user?</p>
      <rs-button style="float: right" class="bg-heandshe hover:bg-heandshe" @click="this.modalDelete = false">
        No
      </rs-button>
      <rs-button style="float: right" class="mx-1" variant="danger" @click="UserDelete(users1)">
        Yes
      </rs-button>
    </rs-modal>
  </rs-layout>
